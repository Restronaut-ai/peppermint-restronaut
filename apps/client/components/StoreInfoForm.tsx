...
export function StoreInfoForm({
  ...
  const { reset, watch, control, register, setValue, formState, handleSubmit } =
    useForm<FormSchema>({
      mode: "onChange",
      ...
      <Transition.Root show={open} as={Fragment}>
        ...
        >
          ...
          >
            ...
            >
              <strong className="text-foreground/85">Store Information</strong>
                ...
                <TagsInput
                  ...
                  onCreateOption={async (value) => {
                    try {
                      ...
                      const response = await fetch(`/api/v1/tags/${clientId}`, {
                        method: "POST",
